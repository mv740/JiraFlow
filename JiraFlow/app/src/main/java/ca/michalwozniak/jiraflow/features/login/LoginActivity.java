...
public class LoginActivity extends AppCompatActivity implements LoginView {
    ...
    private void setupInputObserver() {
        ...
        Observable.combineLatest(
                ...
                passwordObservable,
                serverUrlObservable,
                (usernameValid, passwordValid, serverUrlValid) -> (usernameValid && passwordValid && serverUrlValid))
                .distinctUntilChanged()
                .subscribe(isValid -> loginButton.setEnabled(isValid));
    }
    ...
    @Override
    public void timeout() {
        new Handler().postDelayed(() -> showErrorSnackBar("Failed To connect to server!"), 2000);
    }
